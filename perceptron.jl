...
# ╔═╡ fce2cf11-c15e-4563-b359-2f891b138337
using Plots

# ╔═╡ 7828f28f-eca8-4e4e-89ff-252000fee52f
using LinearAlgebra

# ╔═╡ cc06786a-5c6d-4da5-ae16-394e109ff776
using Statistics

# ╔═╡ 642b307a-4bcd-433d-84cc-07506bc0e2e5
plotly()

# ╔═╡ 849ee3da-8500-11ec-24a9-398c65be1fb7
md" # _Perceptron!_
A perceptron in Julia.
"

# ╔═╡ ec77ab21-01de-4b28-b081-b7cac604aa53
"""
...
# ╔═╡ 5cbdc1e0-bbaf-4ae3-b0cc-49c3bbb7ae1a
"""
...
# ╔═╡ 1dd5ba29-c8c4-4007-b50a-9a266e7d641b
...
# ╔═╡ 145d0876-b292-43b8-b369-547addde737a
...
"""
function perceptron_predict(weights::Vector{Float64}, bias::Float64, X::Matrix{Float64})::BitVector
	scores = X * weights .+ bias
	return [ score > 0 for score in scores ]
end	

# ╔═╡ 3da00311-10bd-4be4-8d36-8e8d22e7248b
"""perceptron_predict(perceptron::Perceptron, X::Matrix{Float64})::BitVector

Returns the predictions given by the `perceptron`.
"""
function perceptron_predict(perceptron::Perceptron, X::Matrix{Float64})::BitVector
	scores = X * perceptron.weights .+ perceptron.bias
	return [ score > 0 for score in scores ]
end

# ╔═╡ fc538379-5a1c-4602-ab41-2a627e943bfc
...
"""
function perceptron_train_b(X::Matrix{Float64}, Y::BitVector, maxIters::Int64=Int64(1e6))
	nDims = size(X, 2)
	nExamples = size(X, 1)
...
# ╔═╡ 48c96797-d0b6-4426-9b50-6a93459cdc66
...
# ╔═╡ ee05aee9-d0e0-4644-a5ff-cbfa66fc16c2
...
# ╔═╡ c9116353-eb50-42e0-821f-7a5338e4cc7f
"""function plot_perceptron_and_examples(perceptron::Perceptron, X::Matrix{Float64}, Y::BitVector)
...
# ╔═╡ f23758e2-a877-4b71-862e-fcd684785a94
md"## _Training a Perceptron!_"

# ╔═╡ e4bf2be3-e97f-48d9-a731-98571cac52a3
X, Y = generate_examples(1000, 0.5, 2)

# ╔═╡ 5e231585-e252-4df1-b316-9fb3d2e1180c
perceptron = perceptron_train_b(X, Y)

# ╔═╡ 53721437-fbc2-4e89-beeb-f9fd00e4fe71
plot_perceptron_and_examples(perceptron, X, Y)

# ╔═╡ 2a5940ed-9e9c-4605-a5e0-aeb0c3b1af18
begin
